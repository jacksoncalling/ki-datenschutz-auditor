...
- `demo/`: frozen `TEST_METHOD.md` + a mixed dossier for a recorded cold-agent run (in progress at last edit).
- Open thread: a corporate/SME reframe (same engine, reader becomes a company DSB evaluating an AI SaaS vendor). Josh's real business interest, likely stronger than the government market.
